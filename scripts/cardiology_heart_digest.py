...
{{
  ...
  "summary": "3 sentences max: what researchers did, who participated (N=X, age range, cardiac history if relevant), key finding in plain language — verified against abstract",
  "why_it_matters": "1 sentence max. of real-world significance for people concerned about heart health. Do NOT imply clinical action.",
